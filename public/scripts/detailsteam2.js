...
function insertPlayerHeadRow()
{
    ...
    $("#players thead tr").append($("<th>", { text: "Player Name" ,style:"background-color:#33475b"}))
        .append($("<th>", { text: "Email Address" ,style:"background-color:#33475b"}))
...
function insertPlayerRow(details, i)
{
    ...
    $("#players tbody tr:last td:last").append($("<a>", {
        href: "detailsplayer2.html?&id=" + details.TeamId + "&playerid=" + details.Members[i].MemberId,
        id: "editBtn" + [i],
