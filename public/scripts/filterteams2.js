...
function insertHeadRow()
{
    ...
    $("#teams thead tr").append($("<th>", { text: "Team Name",style:"background-color:#33475b" }))
        .append($("<th>", { text: "Division" ,style:"background-color:#33475b"}))
        .append($("<th>", { text: "Manager Name" ,style:"background-color:#33475b"}))
        .append($("<th>", { colspan: "2", text: "Actions", class: "text-center" ,style:"background-color:#33475b"}));
}
...
function insertRow(teams, i)
{
    ...
    $("#teams tbody tr:last td:last").append($("<a>", {
        href: "detailsteam2.html?&id=" + teams[i].TeamId,
        id: "editBtn" + [i],
